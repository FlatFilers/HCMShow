/*
  ...
  - A unique constraint covering the columns `[organizationId,name]` on the table `Job` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Job_organizationId_name_key" ON "Job"("organizationId", "name");
